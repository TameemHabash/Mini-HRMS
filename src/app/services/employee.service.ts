...
export class EmployeeService {
  ...
  constructor(private departmentSecvice: DepartmentService, private sectorService: SectorService) {
    ...
    this.allEmployees = [
      new Employee(1, 'wesam sameer', 'female', '253-59-1134', '+962790000001', 'Jordanian', '9942000001', '1994-10-12', '2018-6-25', 5.9, 'amman - dahyat al-amir hasan', 'married', 'wesam.sameer@gmail.com', true, 1, 2, 1),
      new Employee(2, 'nisreen ahmad', 'female', '795-14-4343', '+962790000003', 'Jordanian', '9952000003', '1995-4-16', '2017-5-6', 9.1, 'amman - jawa', 'single', 'nisreen.ahmad@gmail.com', true, 3, 6, 1),
      new Employee(3, 'jehad sameer', 'male', '488-29-3999', '+962790000004', 'Jordanian', '9961000004', '1996-10-5', '2020-9-6', 7.9, 'amman - airport street', 'single', 'jehad.sameer@gmail.com', true, 2, 5, 1),
      new Employee(4, 'mohammad ali', 'male', '123-44-5285', '+962790000005', 'Jordanian', '9951000005', '1995-11-9', '2019-6-20', 6.9, 'amman - alyaduda', 'single', 'mohammad.ali@gmail.com', true, 2, 4, 1),
      new Employee(5, 'noor ahmad', 'female', '841-17-9838', '+962790000006', 'Jordanian', '9952000006', '1995-12-5', '2017-5-22', 9.8, 'az-zarqa', 'married', 'noor.ahmad@gmail.com', false, 1, 1, 1),
      new Employee(6, 'salam nasser', 'female', '388-95-8144', '+962790000007', 'Jordanian', '9952000007', '1995-5-16', '2020-7-1', 10.0, 'amman - dahyet alrasheed', 'single', 'salam.nassar@gmail.com', true, 3, 5, 1),
      new Employee(7, 'tameem habash', 'male', '817-82-5966', '+962796203420', 'Jordanian', '9981000008', '1998-11-5', '2020-8-1', 7.9, 'amman - dahyat al-amir hasan', 'single', 'tameem.habash@gmail.com', true, 3, 6, 1),
      ...
      new Employee(20, 'noor ahmad', 'female', '841-17-9838', '+962790000006', 'Jordanian', '9952000006', '1995-12-5', '2017-5-22', 9.8, 'az-zarqa', 'married', 'noor.ahmad@gmail.com', true, 1, 3, 1),
